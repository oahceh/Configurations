...
namespace UnityEngine.UI
{
  ...
  public class ScrollRect : UIBehaviour, IInitializePotentialDragHandler, IBeginDragHandler, IEndDragHandler, IDragHandler, IScrollHandler, ICanvasElement, ILayoutElement, ILayoutGroup, IEventSystemHandler, ILayoutController
  {
    ...
    private void UpdateCachedData()
    {
      ...
      bool flag1 = (UnityEngine.Object) this.viewRect.parent == (UnityEngine.Object) transform;
      bool flag2 = !(bool) ((UnityEngine.Object) this.m_HorizontalScrollbarRect) || (UnityEngine.Object) this.m_HorizontalScrollbarRect.parent == (UnityEngine.Object) transform;
      bool flag3 = !(bool) ((UnityEngine.Object) this.m_VerticalScrollbarRect) || (UnityEngine.Object) this.m_VerticalScrollbarRect.parent == (UnityEngine.Object) transform;
      bool flag4 = flag1 && flag2 && flag3;
      this.m_HSliderExpand = flag4 && (bool) ((UnityEngine.Object) this.m_HorizontalScrollbarRect) && this.horizontalScrollbarVisibility == ScrollRect.ScrollbarVisibility.AutoHideAndExpandViewport;
      this.m_VSliderExpand = flag4 && (bool) ((UnityEngine.Object) this.m_VerticalScrollbarRect) && this.verticalScrollbarVisibility == ScrollRect.ScrollbarVisibility.AutoHideAndExpandViewport;
    ...
    private static void UpdateOneScrollbarVisibility(
      ...
      bool xAxisEnabled,
      ScrollRect.ScrollbarVisibility scrollbarVisibility,
      Scrollbar scrollbar)
    {
    ...
    internal static Bounds InternalGetBounds(
      Vector3[] corners,
      ref Matrix4x4 viewWorldToLocalMatrix)
    {
