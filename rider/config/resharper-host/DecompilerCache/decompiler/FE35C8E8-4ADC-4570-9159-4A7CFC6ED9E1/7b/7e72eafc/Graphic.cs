...
namespace UnityEngine.UI
{
  ...
  public abstract class Graphic : UIBehaviour, ICanvasElement
  {
    ...
    public CanvasRenderer canvasRenderer
    {
      get
      {
        if (object.ReferenceEquals((object) this.m_CanvasRenderer, (object) null))
    ...
    public virtual void OnRebuildRequested()
    {
      foreach (MonoBehaviour component in this.gameObject.GetComponents<MonoBehaviour>())
      {
        if (!((UnityEngine.Object) component == (UnityEngine.Object) null))
          component.GetType().GetMethod("OnValidate", BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic)?.Invoke((object) component, (object[]) null);
      }
    }
